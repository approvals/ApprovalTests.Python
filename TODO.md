1. finish docs for markdowntable
2. __init.py should be autogenerated?!?!
3. markdown snippets - regex (?<!(a>.*\n))```py
...
10. make code more pythonic (method overloads vs default parameters)
11. _Have_ Oliver and Emily talk about pytest plugin is intergrated in hypoethesis
12. templated namer
