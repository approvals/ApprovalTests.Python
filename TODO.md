2. Python Minimal
   1. create new pypi project 
   3. need a modifidied version of dependcies for said project
   2. create new action to deploy to new project

   4. Update docs to let people know
   5. test final result
   6. check if there is a standard
   7. 
3. 
