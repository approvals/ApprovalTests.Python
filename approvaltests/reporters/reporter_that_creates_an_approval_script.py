...
class ReporterThatCreatesAnApprovalScript(Reporter):
    ...
    def create_script_unix(self):
        ...
        ReporterThatCreatesAnApprovalScript.file = APPROVAL_TESTS_TEMP_DIRECTORY / "approval_script.sh"
    ...
    def create_script_windows(self):
        APPROVAL_TESTS_TEMP_DIRECTORY.mkdir(parents=True, exist_ok=True)
        ReporterThatCreatesAnApprovalScript.file = APPROVAL_TESTS_TEMP_DIRECTORY / "approval_script.bat"
