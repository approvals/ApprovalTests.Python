...
```
<sup><a href='/tests/test_simple_logger.py#L78-L85' title='Snippet source file'>snippet source</a> | <a href='#snippet-verify_simple_logger_example' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
def test_variable_explict() -> None:
    ...
    verify(output)
```
<sup><a href='/tests/test_simple_logger.py#L88-L96' title='Snippet source file'>snippet source</a> | <a href='#snippet-verify_simple_logger_long_example' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
