...
verify(story)
```
<sup><a href='/tests/test_verify.py#L208-L215' title='Snippet source file'>snippet source</a> | <a href='#snippet-use_storyboard' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
