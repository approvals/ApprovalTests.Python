...
verify(story)
```
<sup><a href='/tests/test_verify.py#L183-L190' title='Snippet source file'>snippet source</a> | <a href='#snippet-use_storyboard' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
