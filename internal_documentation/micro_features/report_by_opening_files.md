# `report_by_opening_files` reporter

The `report_by_opening_files` class provides a simple mechanism to open approved and received files using the system's default application for their file type.
