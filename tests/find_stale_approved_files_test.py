...
if __name__ == "__main__":
    ...
    log_entries_3 = approved_files_3 + ['file3.approved.csv']  # 'file3.approved.csv' is in the log but not in the directory
    ...
    sandbox_dir_6, log_file_path_6 = create_sandbox(approved_files_6, log_entries_6, nested=True)
